...
//    NSArray *titleAry = @[@"扫小票",@"身份",@"卡包",@"AR找一找"];
    NSArray *imgAry = @[@"saoyisao",@"paycode",@"homekajuan",@"homebigqiandao"];
    NSArray *titleAry = @[@"扫一扫",@"付款码",@"卡包",@"身份"];
...
//            if ([view isKindOfClass:[_scanPopView class]]) {
//                return;
//            }
//        }
//        _scanPopView = [[UIView alloc]initWithFrame:CGRectMake(30, WIN_HEIGHT/2-110, WIN_WIDTH-60, 220)];
//        [self.view addSubview:_scanPopView];
//
//        _scanPopView.backgroundColor = [UIColor groupTableViewBackgroundColor];
//        NSArray *arr = [NSArray arrayWithObjects:@"扫小票",@"AR扫一扫",@"扫码付款",@"取消", nil];
//        for (NSInteger i=0; i<4; i++) {
//            UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(0, i*44, _scanPopView.width, 44)];
//            [btn setTitle:arr[i] forState:UIControlStateNormal];
//            [btn addTarget: self action:@selector(clickToScan:) forControlEvents:UIControlEventTouchUpInside];
//            [btn setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
//            btn.tag  = 3000+i;
//            [_scanPopView addSubview:btn];
//
//        }
...
//        [self.delegate.navigationController pushViewController:sVC animated:YES];
        ...
        GoViewController* vc = [[GoViewController alloc] init];
        vc.isParking = YES;
        NSArray *parkArray = [[NSArray alloc]initWithArray:_dataDic[@"member_nav_list"]];
