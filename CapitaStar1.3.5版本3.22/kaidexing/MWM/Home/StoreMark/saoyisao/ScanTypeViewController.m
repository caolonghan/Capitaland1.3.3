...
- (void)createHeadView
{
    ...
    UIButton *detailBtn = [[UIButton alloc]initWithFrame:CGRectMake(WIN_WIDTH-20, NAV_HEIGHT-22, 12, 2)];
    [detailBtn setImage:[UIImage imageNamed:@"iCON_more"] forState:UIControlStateNormal];
    [self.navigationBar addSubview:detailBtn];
    ...
    for (NSInteger i=0; i<titleArray.count; i++) {
        ...
        scanBtn.tag = 1000+i;
      //  [scanBtn setTitleColor:[UIColor yellowColor] forState:UIControlStateSelected];
...
- (void)createView
{
    _bgScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0,-STATUS_BAR_HEIGHT, WIN_WIDTH, WIN_HEIGHT+STATUS_BAR_HEIGHT)];
