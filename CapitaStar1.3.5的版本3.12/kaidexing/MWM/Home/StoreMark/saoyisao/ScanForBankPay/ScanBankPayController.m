...
@interface ScanBankPayController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate, AVCaptureMetadataOutputObjectsDelegate, UIGestureRecognizerDelegate>
...
- (void)viewDidLoad {
    ...
    self.navigationBarTitleLabel.text =@"扫码";
