...
//            }
//        }
        UIView *popView = [[UIView alloc]initWithFrame:CGRectMake(30, WIN_HEIGHT/2-110, WIN_WIDTH-60, 220)];
        [self.view addSubview:popView];
        popView.tag = 555;
        popView.backgroundColor = [UIColor whiteColor];
        NSArray *arr = [NSArray arrayWithObjects:@"扫小票",@"AR扫一扫",@"扫码付款",@"付款码",@"取消", nil];
        for (NSInteger i=0; i<5; i++) {
            UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(0, i*44, popView.width, 44)];
...
- (void)clickToScan:(UIButton *)sender{
    ...
    if (tag==0) {
        ...
        UIView *popView = [self.view viewWithTag:555];
