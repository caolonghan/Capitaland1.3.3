...
//                    btn.userInteractionEnabled = NO;
        ...
        case PWD:
        {
            ...
            [SVProgressHUD showWithStatus:@"数据请求中"];
            NSDictionary * params = [NSDictionary dictionaryWithObjectsAndKeys:_vilaCode, @"vilaCode", _phonenum, @"phone_num", [RSA encryptString:input.text publicKey:PublicKey], @"pass_word",@"1000", @"source",@"APP",@"tag_code",[Global sharedClient].markID,@"mall_id", nil];
            //密码注册接口
