...
- (void)viewDidLoad {
    ...
    //    self.navigationBar.backgroundColor=NAVBGCOLOR;
    ...
    labTitles = @[@[@"asd"],@[@"凯德星积分",@"我的车牌",@"我的订单",@"我的小票",@"我的排号",@"我的活动",@"我的收货地址",@"我的星宝贝",@"我的银行卡",@"我的账单",@"我的会员卡"]];
    iconImgs  = @[@[@"asd"],@[@"kaidexingjifen",@"m_1",@"m_2",@"m_3",@"m_4",@"m_5",@"loc",@"m_6",@"bankcard",@"count",@"membershipcard"]];
...
-(void)loadDataNum{
    ...
    mineTV = [[UITableView alloc] initWithFrame:CGRectMake(0, STATUS_BAR_HEIGHT, WIN_WIDTH, WIN_HEIGHT - STATUS_BAR_HEIGHT-BAR_HEIGHT-45) style:UITableViewStyleGrouped];
    ...
    mineTV.backgroundColor = [UIColor whiteColor];
    // mineTV.estimatedRowHeight = 0;
    if (@available(iOS 11.0, *)) {
        //当有heightForHeader delegate时设置
        mineTV.estimatedSectionHeaderHeight = 0;
        //当有heightForFooter delegate时设置
        mineTV.estimatedSectionFooterHeight = 0;
    }
...
- (UIView*)createTableHeaderView {
    ...
    UIView *headView= [[UIView alloc]initWithFrame:CGRectMake(0, 0, WIN_WIDTH, M_WIDTH(88))];
    ...
    [headView addSubview:mineTHView];
    UIImageView *userIV = [[UIImageView alloc] initWithFrame:CGRectMake(WIN_WIDTH-M_WIDTH(67), M_WIDTH(11),M_WIDTH(56),M_WIDTH(56))];
    ...
    if ([Util isNull:[Global sharedClient].member_id]) {
        nickNameLab.frame=CGRectMake(M_WIDTH(18),0,M_WIDTH(150),M_WIDTH(78));
        nickNameLab.font=[UIFont systemFontOfSize:X_WIDTH(34)];
        nickNameLab.text=@"    点击登陆";
    }else{
        nickNameLab.frame=CGRectMake(M_WIDTH(18),mineTHView.height/2-M_WIDTH(17),M_WIDTH(150),M_WIDTH(34));
        nickNameLab.font = [UIFont systemFontOfSize:X_WIDTH(34)];
        ...
        checkLabel=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMinX(nickNameLab.frame),mineTHView.height-M_WIDTH(16),M_WIDTH(150),M_WIDTH(16))];
        ...
        checkLabel.font = INFO_FONT;
        checkLabel.text = @"查看修改个人档案";
        
        [mineTHView addSubview:checkLabel];
...
-(UIView*)createCellView:(NSIndexPath*)indexPath{
    ...
    UIImageView *iconImg = [[UIImageView alloc]initWithFrame:CGRectMake(WIN_WIDTH-M_WIDTH(28),(view.frame.size.height-M_WIDTH(17))/2,M_WIDTH(17),M_WIDTH(17))];
    [iconImg setImage:[UIImage imageNamed:iconImgs[indexPath.section][indexPath.row]]];
    [view addSubview:iconImg];
    
    UILabel *titleLab = [[UILabel alloc]initWithFrame:CGRectMake(M_WIDTH(18),0,150,M_WIDTH(39))];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==1) {
        if (indexPath.row == 0) {
            ...
            [self.delegate.navigationController pushViewController:billVc animated:YES];
        }
        else if (indexPath.row == 10){
            MyMembershipCardView * mcVC = [[MyMembershipCardView alloc] init];
