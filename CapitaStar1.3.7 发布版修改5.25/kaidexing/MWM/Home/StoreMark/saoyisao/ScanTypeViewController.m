...
@interface ScanTypeViewController ()<UIAlertViewDelegate>
...
- (void)createHeadView
{
    ...
    NSArray *titleArray = [NSArray arrayWithObjects:@"扫码支付",@"拍摄小票",@"AR找一找", nil];
    ...
    _tipView = [[UIView alloc]initWithFrame:CGRectMake(WIN_WIDTH/6, titleView.height-4, WIN_WIDTH/6, 2)];
...
- (void)createView
{
   ...
   // _scanVc.view.frame = CGRectMake(0, 0, WIN_WIDTH, _bgScrollView.height);
    _pushVc.view.frame = CGRectMake(WIN_WIDTH, 0, WIN_WIDTH, _bgScrollView.height);;
    [_bgScrollView addSubview:_pushVc.view];
    _bgScrollView.contentOffset = CGPointMake(WIN_WIDTH, 0);
