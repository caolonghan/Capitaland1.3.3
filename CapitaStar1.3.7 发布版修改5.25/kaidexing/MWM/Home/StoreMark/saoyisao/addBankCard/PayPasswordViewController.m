...
- (void)createViewWithType:(NSInteger )type
{
    ...
    UILabel *titlelabel = [[UILabel alloc]initWithFrame:CGRectMake(WIN_WIDTH/2-90, 100, 180, 44)];
    titlelabel.textColor = [UIColor lightGrayColor];
    titlelabel.textAlignment = NSTextAlignmentCenter;
    [self.view addSubview:titlelabel];
    
    titlelabel.font = COMMON_FONT;
    BJPasswordView * bjPass = [[BJPasswordView alloc]initWithFrame:CGRectMake(10, 150, self.view.frame.size.width-20, 45)];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if ([Global sharedClient].bindCardBackWhere ==0) {
                ...
                for (UIViewController *viewController in self.navigationController.viewControllers) {
                    ...
                    if ([viewController isKindOfClass:[ScanTypeViewController class]]) {
                        [self.navigationController popToViewController:viewController animated:YES];
                    }
