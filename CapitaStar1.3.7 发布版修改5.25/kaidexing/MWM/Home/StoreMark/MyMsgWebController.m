...
- (void)viewDidLoad {
    ...
    UILabel *titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(30,20 , 200, 44)];
    ...
    _webView.frame = CGRectMake(0, NAV_HEIGHT+20, SCREEN_FRAME.size.width, SCREEN_FRAME.size.height - NAV_HEIGHT-BAR_HEIGHT-20);
